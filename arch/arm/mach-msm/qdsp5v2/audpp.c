...
/* FUJITSU:2011-03-18 speaker power ctrl start */
bool check_voice_exec(void);
bool check_use_speaker(void);
/* FUJITSU:2011-03-18 speaker power ctrl end */
...
/* FUJITSU:2011-03-18 speaker power ctrl start */
		if(check_use_speaker())msm_snddev_poweramp_on();
/* FUJITSU:2011-03-18 speaker power ctrl end */
...
void audpp_disable(int id, void *private)
{
	...
	if (--audpp->open_count == 0) {
		...
		allow_suspend();
/* FUJITSU:2011-03-18 speaker power ctrl start */
		if(!check_voice_exec())msm_snddev_poweramp_off();
/* FUJITSU:2011-03-18 speaker power ctrl end */
	}
out:
	mutex_unlock(audpp->lock);
