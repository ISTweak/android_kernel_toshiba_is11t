...
#include <mach/pmic.h> /* FUJITSU:2011-06-21 mic bias */
...
void enable_media_key(bool); /* FUJITSU:2011-04-08 for media key */
...
/* FUJITSU:2011-06-21 mic bias start */
...
static int micbias_ioctl(struct inode *inode, struct file *file,
	unsigned int cmd, unsigned long arg)
{
	int rc = 0;
...
/* FUJITSU:2011-06-21 mic bias end */

/* FUJITSU:2011-04-15 headsethook start */
...
static int headsethook_ioctl(struct inode *inode, struct file *file,
	unsigned int cmd, unsigned long arg)
{
	int rc = 0;
...
/* FUJITSU:2011-04-15 headsethook end */
...
static int wm0010_ioctl(struct inode *inode, struct file *file,
	unsigned int cmd, unsigned long arg)
{
	int rc = 0;
...
/* FUJITSU:2011-04-18 speaker amp ctrl start */
#include <mach/board.h>
bool check_voice_exec(void){
	if (audio_dev_ctrl.voice_rx_dev
		|| audio_dev_ctrl.voice_tx_dev){ /* FUJITSU:2011-05-11 change */
		return true;
	}
	return false;
}
...
/* FUJITSU:2011-04-18 speaker amp ctrl end */
...
static int __init audio_dev_ctrl_init(void)
{
	...
	speaker_amp_state = false; /* FUJITSU:2011-04-18 speaker amp ctrl */
	misc_register(&headsethook_ctrl_misc); /* FUJITSU:2011-04-15 headsethook */
	misc_register(&micbias_ctrl_misc); /* FUJITSU:2011-06-21 mic bias */
	misc_register(&wm0010_ctrl_misc); /* FUJITSU:2011-04-15 wm0010 */
