...
/* FUJITSU:2011-07-26 TS TBL start */
typedef struct{
	unsigned char  S;
	unsigned char  W0;
	unsigned char  W1;
			 ...
			 loff_t *f_pos)
{
	int avail = 0;
	int wi;
/* FUJITSU:2011-07-26 user_buf check start */
	int i,j;
	int off,index;
	unsigned char *user_buf;
/* FUJITSU:2011-07-26 user_buf check end */
	struct tsif_chrdev *the_dev = filp->private_data;
...
/* FUJITSU:2011-07-26 tsif_ioctl start */
/*---------------------------------------------------------------------------
    tsif_ioctl
---------------------------------------------------------------------------*/
/* IOCTL CMD */
...
/* FUJITSU:2011-07-26 tsif_ioctl end */
