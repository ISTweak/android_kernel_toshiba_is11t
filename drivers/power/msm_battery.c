...
/* FUJITSU:2011-05-12 mod Battery start */
#define BATT_UPDATE_TIMEOUT	(2000)
/* FUJITSU:2011-05-12 mod Battery end */
...
/* FUJITSU:2011-05-12 mod Battery end */
/* FUJITSU:2011-07-17 mod Battery start */
struct wake_lock batt_wakelock;
/* FUJITSU:2011-07-17 mod Battery end */


/* FUJITSU:2011-04-20 mod Battery start */
extern int msm_hsusb_chg_status(void);
typedef void (*msm_batt_cbfunc)(void);
extern void msm_reg_battfunc_hsusb(msm_batt_cbfunc func);
extern void msm_reg_battfunc_otg(msm_batt_cbfunc func);
/* FUJITSU:2011-04-20 mod Battery End */
...
/* FUJITSU:2011-07-30 mod Battery start */
static u32 msm_batt_get_vbatt_voltage(int *status)
//static u32 msm_batt_get_vbatt_voltage(void)
/* FUJITSU:2011-07-30 mod Battery end */
{
	int rc;
...
/* FUJITSU:2011-06-15 mod Battery start */
#ifdef CONFIG_MACH_F11EIF
/* FUJITSU:2011-04-20 mod Battery start */
	if(system_rev >= 0x0c) {
		rep_batt_chg.v1.charger_type = msm_hsusb_chg_status();
		if( rep_batt_chg.v1.charger_type != 0 )
			rep_batt_chg.v1.charger_status = CHARGER_STATUS_GOOD;
		else
			rep_batt_chg.v1.charger_status = CHARGER_STATUS_INVALID;
	}
/* FUJITSU:2011-04-20 mod Battery end */
#endif
/* FUJITSU:2011-06-15 mod Battery end */
...
/* FUJITSU:2011-05-24 mod Battery start */
#if 0
		...
		if (charger_type == CHARGER_TYPE_USB_PC ||
			...
			supp = &msm_psy_ac;
#endif
/* FUJITSU:2011-05-24 mod Battery end */
		} else {
			/* FUJITSU:2011-07-17 mod Battery start */
...
/* FUJITSU:2011-07-30 mod Battery start */
			battery_voltage = msm_batt_get_vbatt_voltage(&status);
...
/* FUJITSU:2011-05-18 mod Battery start */
#if 0
...
#endif
/* FUJITSU:2011-05-18 mod Battery end */
...
/* FUJITSU:2011-04-20 mod Battery start */
	msm_reg_battfunc_hsusb(msm_batt_update_psy_status);
	msm_reg_battfunc_otg(msm_batt_update_psy_status);
/* FUJITSU:2011-04-20 mod Battery End */
/* FUJITSU:2011-07-17 mod Battery start */
