...
/* FUJITSU:2011-04-20 for PAD_CAL start */
//			mddi_host_reg_out(PAD_CAL, 0x10220020);
			mddi_host_reg_out(PAD_CAL, 0x11100020);
/* FUJITSU:2011-04-20 for PAD_CAL end */
...
static void mddi_host_initialize_registers(mddi_host_type host_idx)
{
	...
	pad_reg_val = 0x01100020;	/* FUJITSU:2011-04-20 for PAD_CAL */
	...
	mddi_host_reg_out(DRIVER_START_CNT, 0x00380000);	/* FUJITSU:2011-07-28 for MDDI_Stb */
