...
{
	unsigned long cfg;
/* FUJITSU:2011-08-04 DISPLAY_SYNC_TUNE start */

#if 1

	cfg = mfd->total_lcd_lines - 18;
...
/* FUJITSU:2011-08-04 DISPLAY_SYNC_TUNE end */
...
/* FUJITSU:2011-08-04 DISPLAY_SYNC_TUNE start */
				...
				vsync_cnt_cfg_dem =
				    ...
				    ( ( (mfd->panel_info.lcd.refx100 - 300) * 2 ) *     

				      (  mfd->total_lcd_lines - 17 ) ) / 100;
