...
static int msm_fb_register(struct msm_fb_data_type *mfd)
{
	...
	var->height = 89,	/* height of picture in mm *//* FUJITSU:2011-07-13 */
	var->width = 50,	/* width of picture in mm *//* FUJITSU:2011-07-13 */
	var->accel_flags = 0,	/* acceleration flags */
	var->sync = 0,	/* see FB_SYNC_* */
	var->rotate = 0,	/* angle we rotate counter clockwise */
	mfd->op_enable = FALSE;
/* FUJITSU:2011-06-29 CTS start */
	var->reserved[3] = 60;
/* FUJITSU:2011-06-29 CTS end */
...
/* FUJITSU:2011-07-21 change Overrun prevention start */
//	if (fb_num > MAX_FBI_LIST)
	if (fb_num >= MAX_FBI_LIST)
/* FUJITSU:2011-07-21 change Overrun prevention end */
		return -1;
