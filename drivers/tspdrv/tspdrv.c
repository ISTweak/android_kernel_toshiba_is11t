...
/* FUJITSU:2011-07-07 VIB for gp_clk share start */
int vib_set_flag = 0;
/* FUJITSU:2011-07-07 VIB for gp_clk share end */
...
static int ioctl(struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
{
    ...
    switch (cmd)
    {
		...
		/* FUJITSU:2011-07-09 VIB for gp_clk share start*/
        case TSPDRV_FLAG_ON:
        ...
        case TSPDRV_FLAG_OFF:
			vib_set_flag = 0;
			mdelay(1);
			break;
		/* FUJITSU:2011-07-09 VIB for gp_clk share end*/
    }
